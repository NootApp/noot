use iced_core::{alignment, layout, Clipboard, Color, Element, Event, Layout, Length, Pixels, Point, Rectangle, Shell, Size, Vector, Widget};
    ...
    Renderer: iced_core::text::Renderer,
{
    layout::sized(limits, width, height, |limits| {
        ...
        let text_with_spans = || iced_core::text::Text {
            content: spans,
            bounds,
            size,
            line_height,
        ...
        if state.spans != spans {
            ...
            match state.paragraph.compare(iced_core::text::Text {
                content: (),
                bounds,
                size,
                line_height,
